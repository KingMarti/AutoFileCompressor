...
icon = pystray.Icon(r'C:\\Users\cols\\documents\\GitHub\\AutoFileCompressor\\icon.ico')
#global Variables
...
def withdraw_window():
    root.withdraw()
    image= Image.open('c:\\Users\\cools\\Documents\\GitHub\\AutoFileCompressor\\icon.ico')
